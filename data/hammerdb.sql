CREATE TABLE Hammer (
    ...
    INSERT INTO _fields (table_name, field_name, field_type, description) VALUES ('Hammer', 'worth', 'DOUBLE',
        'worthiness of the hammer (ranking for 0 to 1, with 1 indicating best');
